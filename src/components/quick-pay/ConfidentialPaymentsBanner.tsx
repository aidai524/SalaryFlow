    ...
    <AnimatePresence initial={false}>
      {visible ? (
        <motion.div
          ...
          className="mb-4 flex flex-col gap-1 rounded-[12px] border border-primary bg-primary/20 px-4 py-3 sm:flex-row sm:items-center sm:gap-4 sm:px-5"
        >
          <div className="flex min-w-0 flex-1 items-start gap-3 sm:items-center">
            <span className="inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-[#ffffff] text-black">
